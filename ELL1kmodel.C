...
double ELL1kmodel(pulsar *psr,int p,int ipos,int param)
{
    ...
    double omdot;
    //double pa,pbdotcalc; // unused
    double eps1,eps2,eps1dot,eps2dot,si,a0,b0; // note: eps1dot/eps2dot are computed but not used.
    ...
    if (param==param_pb)
        ...
        return 0.5*tt0*(-Csigma*nb*SECDAY*tt0/(pb*SECDAY));
