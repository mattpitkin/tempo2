...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(dotime == 1){
		...
		gettimeofday(&tval_after, NULL);
		timersub(&tval_after, &tval_before, &tval_resultone);
		printf("Time elapsed Up to end of second loop: %ld.%06ld\n", (long int)tval_resultone.tv_sec, (long int)tval_resultone.tv_usec);
		gettimeofday(&tval_before, NULL);

	}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////Second loop over nobs over///////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(dotime == 1){
		...
		gettimeofday(&tval_after, NULL);
		timersub(&tval_after, &tval_before, &tval_resultone);
		printf("Time elapsed Up to end of third loop: %ld.%06ld\n", (long int)tval_resultone.tv_sec, (long int)tval_resultone.tv_usec);
		gettimeofday(&tval_before, NULL);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(psr[p].TNsubtractRed==1){
            for (i=0;i<psr[p].nobs;i++){
		//printf("TNRed: %g %g %g %g \n", (double)psr[p].obsn[i].bat, psr[p].obsn[i].TNRedSignal, psr[p].obsn[i].TNRedSignal+psr[p].obsn[i].TNRedErr, psr[p].obsn[i].TNRedSignal-psr[p].obsn[i].TNRedErr);
		...
		double freq=(double)psr[p].obsn[i].freqSSB;
                longdouble yrs = (psr[p].obsn[i].sat - psr[p].param[param_dmepoch].val[0])/365.25;
                longdouble arg = 1.0;
                double dmDot=0;
                for (int d=1;d<9;d++){
                        arg *= yrs;
                        if (psr[p].param[param_dm].paramSet[d]==1){
                                dmDot+=(double)(psr[p].param[param_dm].val[d]*arg);
                        }
                }


		printf("TNDM: %g %g %g \n", (double)psr[p].obsn[i].bat, psr[p].obsn[i].TNDMSignal*dmkap+dmDot, psr[p].obsn[i].TNDMErr);
